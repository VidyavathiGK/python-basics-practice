...
This repository contains a curated collection of beginner-friendly Python programs, algorithmic scripts, and Object-Oriented Programming (OOP) implementations designed for continuous learning and skill improvement.

## Repository Structure & Programs

### Core Utilities & Mathematics
* **Hello World** (`Hello_world.py`) - Basic introductory output script.
* **Simple Calculator** (`simple_calculator.py`) - Performs fundamental arithmetic calculations.
* **Even or Odd** (`even-odd.py`) - Evaluates whether a given integer is even or odd.
* **Largest of Three** (`largest_of_three.py`) - Compares three numbers to find the maximum value.
* **Factorial** (`factorial.py`) - Computes the factorial of a number using loops or recursion.
...
* **Armstrong Number** (`Armstrong Number.py`) - Validates if a number is equal to the sum of its own digits raised to the power of the number of digits.
* **Neon Number** (`Neon Number.py`) - Checks if the sum of the digits of the square of a number is equal to the number itself.
